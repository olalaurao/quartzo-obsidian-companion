...
| P0.8 DONE vault interoperability | [`object_fixtures/fixtures.json`](../../../contracts/quartzo/object_fixtures/fixtures.json), [`coverage.json`](../../../contracts/quartzo/object_fixtures/coverage.json), `priority_vectors.json`, [`resource_capture/vectors.json`](../../../contracts/quartzo/resource_capture/vectors.json), canonical model serializers and Resource capture policies | 32 model-level parse -> serialize -> parse fixtures, 1 documented raw/read-only `daily_note` fixture, 8 parse/mutate/roundtrip mutation fixtures in `test/obsidian_companion_contracts_test.dart`, plus executable Resource source-detection and duplicate-policy vectors in `test/resource_capture_contract_test.dart` | interop and fixture gates |
