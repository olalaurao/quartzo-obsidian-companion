...
- [ ] CI final — Analyze ✅, Dial Focus CI ✅; Flutter Test e Agent Contract Gate pendentes;
- [ ] merge upstream.
...
- [ ] Certificar o head atual: Analyze ✅; Dial Focus CI ✅; Flutter Test / Agent Contract Gate pendentes.
